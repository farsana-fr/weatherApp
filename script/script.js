function constructFetch() {
  ...
  fetch(`https://api.openweathermap.org/data/2.5/weather?q=${storedLoc}&appid=5b4bee0ba241d092159faf007e166080`)
    .then((e) => e.json())
...
function displayData(data) {
    ...
    html = `
     <div class="center mt-4">
         ...
         <img src="http://openweathermap.org/img/wn/${icon}@4x.png" alt="showWeather" class="w-25">
             ...
             <div class="row mt-5">
                 <h6 class="col-lg-3 col-md-3 col-sm-3"><i class="fa-solid fa-wind me-1"></i>&nbsp;&nbsp;&nbsp;&nbsp;WIND&nbsp; :${wind}kmph</h6>
                 <h6 class="col-lg-3 col-md-3 col-sm-3"><i class="fa-solid fa-droplet me-1"></i>HUMIDITY : ${humid}%</h6>
                 <h6 class="col-lg-3 col-md-3 col-sm-3"><i class="fa-solid fa-eye me-1"></i>VISIBILITY : ${visible/1000}km</h6>
    ...
    if(temp>30)
    {
        document.querySelector('.today').style.backgroundImage="linear-gradient(rgba(241, 101, 20,0.8), rgba(245, 229, 10,0.7))";
    }
